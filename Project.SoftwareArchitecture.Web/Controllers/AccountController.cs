...
using Project.SoftwareArchitecture.Sessions;
using Project.SoftwareArchitecture.Web.Controllers.Results;
using Project.SoftwareArchitecture.Web.Models;
using Project.SoftwareArchitecture.Web.Models.Account;
...
{
    public class AccountController : SoftwareArchitectureControllerBase
    {
